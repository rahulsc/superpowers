...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/forge
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/forge-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using forge:subagent-driven-development. The plan is at: $PLAN_PATH"
