...
mkdir -p "$HOME/.config/opencode/forge"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/forge/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/forge/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/forge/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/forge.js" "$HOME/.config/opencode/forge/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/forge/.opencode/plugins/forge.js" \
       "$HOME/.config/opencode/plugins/forge.js"
...
echo "Plugin installed to: $HOME/.config/opencode/forge/.opencode/plugins/forge.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/forge.js"
