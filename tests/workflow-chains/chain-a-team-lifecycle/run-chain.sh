...
# ── Setup ─────────────────────────────────────────────────────────────────────
TIMESTAMP=$(date +%s)
WORK_DIR="/tmp/superpowers-tests/${TIMESTAMP}/chain-a-team-lifecycle"
mkdir -p "$WORK_DIR"

# Copy project scaffold
cp -r "$CHAIN_DIR/fixtures/project-scaffold/." "$WORK_DIR/"
mkdir -p "$WORK_DIR/docs/ecommerce/design"
cp "$CHAIN_DIR/fixtures/design.md" "$WORK_DIR/docs/ecommerce/design/design.md"
