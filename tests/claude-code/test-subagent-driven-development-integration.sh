...
mkdir -p src test docs/test-project/plans

# Create a simple implementation plan
cat > docs/test-project/plans/plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/test-project/plans/plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from forge directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/test-project/plans/plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"forge:subagent-driven-development"' "$SESSION_FILE"; then
