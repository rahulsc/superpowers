...
**Pairs with:**
- **forge:requesting-code-review** — the other side of the review process; handles dispatching review and processing results
- **forge:verification-before-completion** — canonical evidence format for review verdicts
