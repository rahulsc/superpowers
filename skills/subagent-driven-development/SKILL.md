...
digraph when_to_use {
    ...
    "Stay in this session?" -> "subagent-driven-development" [label="no - parallel session"];
}
```
...
- **forge:subagent-driven-development** - Use for parallel session instead of same-session execution
